...
-- Run this file once on a FRESH PostgreSQL database only.
--
-- IMPORTANT: For any schema change on an EXISTING database
-- (adding columns, new tables, etc.), do NOT edit this file
-- and run it manually. Instead, add a new numbered .sql file
-- to the /migrations folder — it will run automatically the
-- next time the backend deploys. See /migrations/README.md.
-- ============================================================
